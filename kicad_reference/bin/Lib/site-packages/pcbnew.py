...
class FP_CACHE_ITEM(object):
    ...
    def GetFootprint(self):
        r"""GetFootprint(FP_CACHE_ITEM self) -> std::unique_ptr< FOOTPRINT > &"""
...
class LSET(BASE_SET):
    ...
    def Flip(self, aCopperLayersCount=0):
        r"""Flip(LSET self, int aCopperLayersCount=0) -> LSET"""
        return _pcbnew.LSET_Flip(self, aCopperLayersCount)
...
class CONNECTIVITY_DATA(object):
    ...
    def GetConnectedItems(self, aItem, aTypes, aIgnoreNetcodes=False):
        r"""GetConnectedItems(CONNECTIVITY_DATA self, BOARD_CONNECTED_ITEM aItem, std::vector< KICAD_T,std::allocator< KICAD_T > > const & aTypes, bool aIgnoreNetcodes=False) -> std::vector< BOARD_CONNECTED_ITEM *,std::allocator< BOARD_CONNECTED_ITEM * > > const"""
...
class FOOTPRINT(BOARD_ITEM_CONTAINER):
    ...
    def ClearFields(self):
        r"""ClearFields(FOOTPRINT self)"""
        return _pcbnew.FOOTPRINT_ClearFields(self)
    ...
    def GetNextFieldId(self):
        r"""GetNextFieldId(FOOTPRINT self) -> int"""
        return _pcbnew.FOOTPRINT_GetNextFieldId(self)
